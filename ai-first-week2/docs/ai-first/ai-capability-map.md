...
| **AI Support Assistant** | Get instant help with orders & policies | FAQ markdown, order-status API | 3 | 1000 | $0.210 | Escalate to human agent | ✅ FAQ + API exist | ✅ |
...
- Achieve target latencies (Search <250ms, Support <1000ms) at p95
